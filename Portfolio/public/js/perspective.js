...
el.on('mousemove', function (e) {		
  ...
  $(this).css('-webkit-transform', 'perspective(500px) rotateX(' + cursFromCenterY / 40 + 'deg) rotateY(' + -(cursFromCenterX / 40) + 'deg) translateZ(10px)');   
  ...
  $(this).find('.js-perspective-neg').css('-webkit-transform', 'translateY(' + cursFromCenterY / 10 + 'px) translateX(' + -(invertedX / 10) + 'px) scale(1.15)');   
